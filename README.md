[![Run App Teighan Peterson](https://github.com/teighannn/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/teighannn/GithubActions/actions/workflows/run-app.yaml)
